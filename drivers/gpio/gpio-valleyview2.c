...
static int vlv_gpio_runtime_suspend(struct device *dev)
{
	return 0;
}

static int vlv_gpio_runtime_resume(struct device *dev)
{
	return 0;
}

static const struct dev_pm_ops vlv_gpio_pm_ops = {
	.runtime_suspend = vlv_gpio_runtime_suspend,
	.runtime_resume = vlv_gpio_runtime_resume,
};
